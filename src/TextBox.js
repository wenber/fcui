...
define(function (require, exports, module) {
        ...
        },
        {
            ...
            paint: function (textbox, placeholder) {
                ...
                if (supportPlaceholder) {
                    ...
                    label.innerHTML = _.escape(placeholder || '');
                }
                togglePlaceholder(textbox);
            }
        },
     ...
     * @override
     */
    proto.getValidityLabel = function () {
     ...
     * @protected
     */
    proto.getRawValueProperty = proto.getRawValue;

    // var TextBox = oo.derive(InputControl, proto);
