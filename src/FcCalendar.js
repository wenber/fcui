...
define(function (require) {
     ...
     * @constructor
     */
    function FcCalendarLayer() {
        Layer.apply(this, arguments);
    }

    lib.inherits(FcCalendarLayer, Layer);

    FcCalendarLayer.prototype.render = function (element) {
        document.body.appendChild(element);
        element.innerHTML = '<div data-ui-type="FcMonthView" '
    ...
    FcCalendarLayer.prototype.toggle = function () {
    ...
    function FcCalendar() {
        ...
        this.layer = new FcCalendarLayer(this);
    }
     ...
     * 更新显示的文字
     *
     * @param {FcCalendar} calendar 控件实例
     * @ignore
     */
    ...
    FcCalendar.prototype = {
        ...
        initOptions: function (options) {
            ...
            var properties = {
                 ...
                 *
                 * 输出的日期格式，用于{@link FcCalendar#getValue}返回时格式化
                 *
                 * 具体的日期格式参考
                 ...
                 *
                 * 输入的日期格式，用于{@link FcCalendar#setValue}时格式化
                 *
                 * 具体的日期格式参考
                 * [moment文档](http://momentjs.com/docs/#/displaying/format/)
                 */
        ...
        repaint: require('./painters').createRepaint(
            InputControl.prototype.repaint,
            {
                ...
                paint: function (calendar, rawValue, range) {
                    ...
                    if (calendar.helper.isInStage('RENDERED')) {
    ...
    lib.inherits(FcCalendar, InputControl);
    ui.register(FcCalendar);
